...
document.getElementById('saveTemplateBtn').addEventListener('click', async ()=>{
  ...
  try{
    ...
    const textFont = document.getElementById('tplFont').value;
    const textColor = document.getElementById('tplTextColor').value.trim() || '#333333';
    const textAlign = document.getElementById('tplTextAlign').value;
    const textSize = Number(document.getElementById('tplTextSize').value) || 8;
    const photoZoneBg = document.getElementById('tplPhotoZoneBg').value.trim() || '#ffffff';
    const textZoneBg = document.getElementById('tplTextZoneBg').value.trim() || '#ffffff';
    ...
    await db.collection('obituaryTemplates').add({
      ...
      imageUrl,
      photoZone, textZone,
      textFont, textColor, textAlign, textSize,
      photoZoneBg, textZoneBg,
