  ...
  return `
    <div class="artwork-scale-wrap">
      <div class="artwork-canvas" id="artworkCanvas" style="${canvasStyle}">
        ...
        <div id="artworkBodyText" contenteditable="true" data-base-size="${base.body}"
          style="position:absolute; left:${tz.left}%; top:${tz.top}%; width:${tz.width}%; height:${tz.height}%; overflow:hidden; z-index:1; text-align:center; font-size:${base.body}pt; font-family:Georgia, 'Times New Roman', serif;">${safeContent}</div>
      </div>
    </div>
